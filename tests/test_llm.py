...
class LlmTest(unittest.TestCase):
    ...
    def test_openai_workflow_model_routing_uses_fast_next_session_and_quality_turn_feedback_models(self):
        from app.config import Settings
        ...
        self.assertEqual(model_for_workflow("session_feedback", settings), "gpt-4o-mini")
        ...
        self.assertIsNone(fallback_model_for_workflow("session_feedback", settings))
