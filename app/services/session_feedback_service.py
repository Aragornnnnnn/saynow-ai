...
def _generate_turn_reason(
    ...
    system = (
        ...
        "유저의 발화에 대해 한국어로 1문장 피드백을 작성하세요. \"피드백:\", \"개선:\", \"참고:\" 같은 레이블 없이 바로 문장으로 시작하세요. 최대한 영어 단어를 섞지 말고 완전한 한국어로만 작성하세요 (영어 예문 인용은 제외). "
        "평가 기준은 다음과 같습니다:\n"
        ...
        "피드백은 문제 유형에 따라 다양하게 작성하세요:\n"
        "- 문법 오류(관사, 복수형, 시제 등): 어떤 문법이 틀렸는지 명시 (예: '관사 \"a\"가 빠져서 어색합니다.')\n"
        "- 어순/문장 구조 오류: 올바른 구조를 설명 (예: '의문문은 \"Do you...\" 형태로 써야 합니다.')\n"
        "- 직역투/어색한 표현: 왜 어색한지 설명 (예: '\"I want\" 는 다소 직접적인 표현이고, \"I'd like\"이 더 공손합니다.')\n"
        "- 맥락 부적절: 질문과 동떨어진 이유 설명 (예: '추천을 물어봤는데 가격을 물어봐서 대화 흐름이 어긋납니다.')\n"
        "모든 피드백을 \"더 자연스럽습니다\"로 끝내지 마세요."
    )
    user = (
        f"AI 질문: {question}\n"
        f"유저 발화: {transcript}\n"
